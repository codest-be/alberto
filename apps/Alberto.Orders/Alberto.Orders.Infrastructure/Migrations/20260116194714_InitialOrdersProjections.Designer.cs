...
namespace Alberto.Orders.Infrastructure.Migrations
{
    ...
    [Migration("20260116194714_InitialOrdersProjections")]
    partial class InitialOrdersProjections
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Alberto.Orders.Infrastructure.Entities.OrderLineItemEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "OrderDocumentId");

                    b.HasIndex("TenantId", "ProductId")
                        .HasDatabaseName("ix_order_line_items_tenant_product");

                    b.ToTable("order_line_items", "orders");
                });
            ...
            modelBuilder.Entity("Alberto.Orders.Infrastructure.Entities.OrderLineItemEntity", b =>
                {
                    b.HasOne("Alberto.Orders.Infrastructure.Entities.OrderSummaryEntity", "Order")
                        .WithMany("LineItems")
                        .HasForeignKey("TenantId", "OrderDocumentId")
