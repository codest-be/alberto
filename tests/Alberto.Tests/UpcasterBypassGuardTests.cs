...
public sealed class UpcasterBypassGuardTests
{
    ...
    private static readonly IReadOnlyDictionary<string, string> AllowedFiles =
        new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["Alberto/Upcasting/UpcasterDeclaration.cs"] =
            ...
            ["Alberto/EventEnvelopeExtensions.cs"] =
            ...
            ["Alberto.Testing.Xunit/EventStoreBackendSpecification.cs"] =
