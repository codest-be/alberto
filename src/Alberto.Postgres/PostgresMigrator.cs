...
public static class PostgresMigrator
{
    ...
    {
        // Script names are like "Alberto.Postgres.Migrations.001_InitialSchema.sql"
        // or "Alberto.Postgres.Migrations.SingleTenant.001_InitialSchema.sql"
        var prefix = $"Alberto.Postgres.{folderPath}.";
