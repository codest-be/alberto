...
public readonly record struct Result
{
    ...
    public static Result Fail(string message) => Fail(Problem.Create("Error", message));
...
public readonly record struct Result<T>
{
    ...
    public static Result<T> Fail(string message) => Fail(Problem.Create("Error", message));
