...
$$
    BEGIN
        IF NOT EXISTS (SELECT 1
            ...
            CREATE TABLE payments.__alberto_schema_version
            (
                migration_name
        ...
        IF NOT EXISTS (SELECT 1
                       FROM payments.__alberto_schema_version
            ...
            CREATE INDEX IF NOT EXISTS idx_payments_events_tags
                ON payments.events USING GIN (tags);
            ...
            CREATE INDEX IF NOT EXISTS idx_payments_subscription_checkpoints_updated
                ON payments.subscription_checkpoints (updated_at DESC);
            ...
            CREATE INDEX IF NOT EXISTS idx_payments_poison_pills_subscription
                ON payments.subscription_poison_pills (subscription_id);

            CREATE INDEX IF NOT EXISTS idx_payments_poison_pills_event
                ON payments.subscription_poison_pills (event_id);

            CREATE INDEX IF NOT EXISTS idx_payments_poison_pills_unresolved
                ON payments.subscription_poison_pills (subscription_id, last_failed_at)
                WHERE resolved_at IS NULL;

            -- Record migration
            INSERT INTO payments.__alberto_schema_version (migration_name, applied_at, is_breaking, description)
