...
/// instruments. <c>Alberto.Telemetry</c>'s <c>TelemetryTags</c> delegates here so that
...
/// consumer extension point. <c>Alberto.Telemetry</c> and <c>Alberto.Tests</c> both
/// receive access via <c>InternalsVisibleTo</c> in <c>Alberto.csproj</c>.
/// </remarks>
