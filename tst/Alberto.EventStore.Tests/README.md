...
This directory contains comprehensive tests for the EventStore library, ensuring robust functionality across all backend
implementations.
...
The test suite follows a **specification pattern** where abstract base classes define contracts that all backend
